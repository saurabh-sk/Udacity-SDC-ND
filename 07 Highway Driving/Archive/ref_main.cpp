        ...
        if (s != "")
        {
          ...
          if (event == "telemetry")
          {
            ...
            for(int i=0; i<sensor_fusion.size(); i++ )
            {
              ...
              if (other_car_lane < 0) // Other vehicle is going in opposite direction
              {
                continue;
              }
              ...
              // Determine other car's position at the end of current cycle
              other_car_s += ((double)num_pts_prev_path*0.02*other_car_speed);

              // Are there any other car' in front/left/right?
              ...
              {
                // Check if we can move to left lane
              ...
              {
                // Check if we can move to right lane
                if((car_s-30) < other_car_s && (car_s+30) > other_car_s)
                {
